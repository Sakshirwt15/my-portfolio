...
const skills = [
  ...
  // CS Fundamentals
  { name: "Data Structures & Algorithms", level: 85, category: "cs" },
  { name: "OOP", level: 80, category: "cs" },
  { name: "DBMS", level: 75, category: "cs" },
  { name: "Operating Systems", level: 70, category: "cs" },
  { name: "Computer Networks", level: 70, category: "cs" },
